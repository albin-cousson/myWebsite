...
/* harmony import */ var _styles_skills_module_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(880);
...
/* harmony import */ var matter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(438);
...
function Skills({ refForNavigate  }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        if (boxIsInView) {
            bodies.push(Bodies.circle(clientWidth / 2 - 60, 120, 58, {
                frictionAir: 0.02,
                restitution: 0.6,
                render: {
                    sprite: {
